const CartItem = (props) => {
    ...
    return (
        <div key={cartItem.id}>
            <div className="flex gap-5 font-mono text-lg px-16 ml-4 mr-4 border-2 rounded">
                <div>
                ...
                <div>
                    <button className="text-red-500 rounded-full px-4 mb-4 hover:bg-red-200" onClick={() => removeFromCart(cartItem.id)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
